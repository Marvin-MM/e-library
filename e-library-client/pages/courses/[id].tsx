...
import { GraduationCap, ArrowLeft, FileText, Download, Calendar, Clock, BookOpen, Search, Filter } from "lucide-react";
...
export default function CourseDetailPage() {
  ...
  const { data: resourcesData, isLoading: loadingResources } = useCourseResources(id as string, {
    limit: 100, // Fetch more for the list view
